...
We as members, contributors, and maintainers of BIME — the BioInception
Molecular Editor — pledge to make participation in our community a
...
- Focusing on what is best not just for us as individuals, but for the
  overall community.
- Citing prior work accurately. Crediting the chemists and computer
  scientists whose published algorithms make BIME possible.
...
- Submitting code containing private or unlicensed third-party material,
  including code generated by tools whose output you do not have a clear
  licence to use.
- Submitting plagiarised research, fabricated chemistry data, or
...
public documentation, social-media interactions tagged with the project,
and any in-person or virtual events organised under the project's name.
...
**asad.rahman@bioinceptionlabs.com**
