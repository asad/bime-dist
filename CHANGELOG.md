...
- **Ring-quality breakthrough.** Final layout pass now produces clean
  regular polygons across fused ring systems, eliminating the
  distortions that v1.8.14 still showed on chromophore-class molecules.
  On the bisazo-dye SDG benchmark: 6/6 rings now drawn as perfect
  hexagons (was 0/6 in v1.8.14).
