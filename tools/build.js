...
var FILES = [
    ...
    'SMSDBatch.js',
    'SMSDLayout.js',
    // v1.8.13: CDK Structure-Diagram-Generator-faithful corrective pass
    // (loaded eagerly so Layout.options.useSDG can flip on at runtime).
    'SDGLayout.js',
    // v1.8.13: CDK SDG class-by-class port (see editor/sdg/*.js).
    // Loaded as a flat namespace under globalThis.SDG. Some are full
    // implementations (Congestion, HydrogenPlacer, OverlapResolver,
    // AtomPlacer); others are scaffolded for upcoming v1.8.x patches.
    // Reference:
    //   https://github.com/cdk/cdk/tree/main/tool/sdg/src/main/java/org/openscience/cdk/layout
    'sdg/Congestion.js',
...
function main() {
    ...
    HTML_PAGES.forEach(function (page) {
        ...
        // v1.8.13: extended pattern to include dist/ (the bundle) — without
