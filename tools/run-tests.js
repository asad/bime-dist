/**
 * tools/run-tests.js — BIME regression test runner.
 *
...
var versionInfo = require(path.join(__dirname, '..', 'versions.json'));
...
console.log('=== BIME v' + versionInfo.bime + ' Regression Test Suite ===');
console.log('');
