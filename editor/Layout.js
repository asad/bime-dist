...
(function (global) {
    ...
    Layout.options = {
        ...
        // is the conservative-average prediction that improves both
        // BIME-template-style and chemist-drawn-style coords; the
        // other tags bias toward their respective drawing style if
        // the caller knows the structure's provenance. Default is
        // 'unknown' for safety.
