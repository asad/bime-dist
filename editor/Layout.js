...
(function (global) {
     ...
     *     v1.6.0-alpha experimental ML residual refinement. Requires
     ...
     *     Off by default; opt-in for cases where the rule-based pipeline
     *     leaves room for a learned refinement.
     *
    ...
    function layoutComponent(mol, atomIds) {
        ...
        // -- Step 12 (v1.6.0-alpha): ML residual refinement (opt-in) -------
