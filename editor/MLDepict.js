...
(function (global) {
    ...
    // ---------------------------------------------------------------------
    // Forward pass.
    //   v1.6.x : 40 ->  64 -> 32 -> 2 (focal + 1-hop pool)
    //   v1.8.0 : 84 -> 128 -> 64 -> 2 (focal + 1-hop + 2-hop + 3-hop pool
    //                                  + 4-channel source one-hot)
    // The forward pass auto-detects which arch the loaded weights file
    // expects via w.arch.in (40 vs 84). Older weights still work; new
    // weights need new inputs.
    // ---------------------------------------------------------------------
