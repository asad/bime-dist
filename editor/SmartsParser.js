...
(function(global) {
    ...
    // table adds 'R': 0 — harmless here since SMARTS parses `R` as the
    // ring-count primitive, never as an element-symbol lookup.
        ...
        while (pos < len) {
            ...
            if (c === ':') {
                ...
                if (mapStr) {
                    ...
                    // FIX: SMARTS map number requires at least one digit after ':'.
                    // Previously an empty map number was silently dropped.
                    errors.push('Empty atom map number after ":"');
                }
                continue;
            }
