...
(function() {
    ...
    // ========================================================================
    // GF(2) Pipeline (shared between SSSR and RCB)
    // ========================================================================

    /**
     * Run the full candidate cycle enumeration and 2-phase GF(2) pipeline.
     *
     * @param {Object} g  Graph with .n and .neighbors[]
     * @return {{ sssr: Array<Array<number>>, rcb: Array<Array<number>> }}
     */
    function runCyclePipeline(g) {
        var result = { sssr: [], rcb: [] };
     ...
     *
     * Algorithm:
     *   1. candidate cycle enumeration: for every vertex v and every edge (eU,eV),
    ...
    function computeRings(g) {
        return runCyclePipeline(g).sssr;
    }
