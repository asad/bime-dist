...
(function(global) {
    ...
    // "Pan Mol" button. Every drag translates EVERY atom by the cursor delta,
    // unlike MoveTool which drags individual atoms (and only pans the camera
    // on empty-canvas clicks — an undocumented affordance).
    // =========================================================================
